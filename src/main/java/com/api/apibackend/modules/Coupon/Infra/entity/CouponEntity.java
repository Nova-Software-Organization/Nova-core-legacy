...
public class CouponEntity implements Serializable {
    ...
    /**
     * Retorna o valor do desconto arredondado para um inteiro.
     * @return O valor do desconto arredondado como inteiro.
     */
    public int getRoundedDiscountValue() {
        return (int) Math.round(discountValue);
    }
}
