...
public class ProductAddService implements IProductAddService {
    ...
    public ResponseEntity<String> addProducts(List<Product> productDTOList) {
        ...
        for (Product productDTO : productDTOList) {
            try {
                ...
                SupplierEntity supplier = this.supplierSave(productDTO);
                ...
                this.priceSaveProduct(productDTO, newProduct);
    ...
    private void priceSaveProduct(Product productDTO, ProductEntity newProduct) {
    ...
    private SupplierEntity supplierSave(Product productDTO) {
